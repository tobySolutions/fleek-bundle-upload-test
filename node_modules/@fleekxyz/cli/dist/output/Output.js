...
class Output {
    constructor({ stream, debug: debugEnabled = false } = {
        ...
        this.warn = (message) => {
            this.print(message, { prefix: { message: `${"\u26A0\uFE0F" /* Icons.Warning */} ${(0, translation_1.t)('warning')}!` } });
            this.printNewLine();
        };
        ...
        this.error = (message) => {
            this.print(message, { prefix: { message: `${"\u274C" /* Icons.Cross */} ${(0, translation_1.t)('error')}:` } });
            this.printNewLine();
        };
        this.ready = (message) => {
            this.print(message, {
        ...
        this.success = (message) => {
            this.print(message, { prefix: { message: `${"\u2705" /* Icons.Checkmark */} ${(0, translation_1.t)('success')}!` } });
            this.printNewLine();
        };
        this.link = (url) => {
        ...
        this.debug = (message) => {
            if (this.debugEnabled) {
                ...
                // certain colours such as grey might not be the most accessible e.g. white background
                // should be verified against brighter consoles and possibly disable colour
                this.print(message, { prefix: { color: 'gray', message: `${(0, translation_1.t)('debug')}:` } });
                this.printNewLine();
            }
        };
        this.table = (data) => {
