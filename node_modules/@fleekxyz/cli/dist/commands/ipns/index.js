...
exports.default = (program) => {
    const cmd = program.command('ipns').option('-h, --help', 'Print help').description((0, translation_1.t)('ipnsDescription'));
    cmd
        .command('create')
        .description((0, translation_1.t)('ipnsCreateDescription'))
        .option('--siteSlug <string>', (0, translation_1.t)('commonIdentifierXAssignedToSubjectY', { name: 'humanReadableSlugDesc', subject: (0, translation_1.t)('ipnsRecord') }))
        .option('--siteId <string>', (0, translation_1.t)('commonIdentifierXAssignedToSubjectY', { name: (0, translation_1.t)('uniqueIdentifier'), subject: (0, translation_1.t)('ipnsRecord') }))
    ...
    cmd
        ...
        .option('--name <string>', (0, translation_1.t)('commonNameOfSubjectToAction', { name: (0, translation_1.t)('name'), subject: (0, translation_1.t)('ipnsRecord'), action: (0, translation_1.t)('delete') }))
