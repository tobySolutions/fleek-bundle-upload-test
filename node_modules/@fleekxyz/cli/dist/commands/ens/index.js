...
exports.default = (program) => {
    const cmd = program.command('ens').option('-h, --help', (0, translation_1.t)('printHelp')).description((0, translation_1.t)('ensCmdDescription'));
    cmd
        .command('create')
    ...
    cmd
        .command('delete')
        .option('--id <string>', (0, translation_1.t)('commonNameOfSubjectToAction', { name: (0, translation_1.t)('id'), subject: (0, translation_1.t)('ens'), action: (0, translation_1.t)('delete') }))
        .option('--name <string>', (0, translation_1.t)('commonNameOfSubjectToAction', { name: (0, translation_1.t)('name'), subject: (0, translation_1.t)('ens'), action: (0, translation_1.t)('delete') }))
        .description((0, translation_1.t)('ensDelete'))
        .action((options) => (0, delete_1.deleteEnsActionHandler)(options));
    cmd
        .command('verify')
        .option('--id <string>', (0, translation_1.t)('commonNameOfSubjectToAction', { name: (0, translation_1.t)('id'), subject: (0, translation_1.t)('ens'), action: (0, translation_1.t)('verify') }))
        .option('--name <string>', (0, translation_1.t)('commonNameOfSubjectToAction', { name: (0, translation_1.t)('name'), subject: (0, translation_1.t)('ens'), action: (0, translation_1.t)('verify') }))
