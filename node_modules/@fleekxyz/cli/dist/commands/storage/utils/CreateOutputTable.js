...
const createOutputTable = async ({ sdk, storage }) => {
    const privateGatewayDomains = await (0, getAllPrivateGatewayDomains_1.getAllActivePrivateGatewayDomains)({ sdk });
    ...
    return storage.flatMap((s) => {
        ...
        const gatewayUrls = privateGatewayExists
            ? privateGatewayDomains.map((privateGatewayDomain) => (0, utils_1.getPrivateIpfsGatewayUrl)({ hostname: privateGatewayDomain.hostname, hash: s.cid }))
            : [(0, utils_1.getCfIpfsGatewayUrl)(s.cid)];
