...
const deletePrivateGatewayAction = async ({ sdk, args }) => {
    ...
    cli_1.output.success((0, translation_1.t)('commonItemActionSuccess', { subject: `${(0, translation_1.t)('privateGateway')} "${privateGateway.name}"`, action: (0, translation_1.t)('deleted') }));
};
