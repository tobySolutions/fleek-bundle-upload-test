...
const getPrivateGatewayNameOrPrompt = async ({ name }) => {
    ...
    return (0, textPrompt_1.textPrompt)({
        ...
        validate: (partialName) => (0, validation_1.isPrivateGatewayNameValid)({ name: partialName }) || (0, translation_1.t)('gatewayNameIncorrectForm'),
    });
};
