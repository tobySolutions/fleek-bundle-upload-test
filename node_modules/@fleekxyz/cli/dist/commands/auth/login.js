...
exports.createLoginActionHandler = void 0;
...
const createLoginActionHandler = ({ uiAppUrl, authApiUrl }) => async () => {
    ...
    const client = (0, sdk_1.createClient)({ url: authApiUrl });
...
exports.createLoginActionHandler = createLoginActionHandler;
