...
const getProjectNameOrPrompt = async ({ name }) => {
    if (name && (0, validation_1.isProjectNameValid)({ name })) {
        return name;
    }
    if (name && !(0, validation_1.isProjectNameValid)({ name })) {
    ...
    return (0, textPrompt_1.textPrompt)({
        ...
        validate: (partialName) => (0, validation_1.isProjectNameValid)({ name: partialName }) || (0, translation_1.t)('mustHaveXandYValidChars', { min: '3', max: '30' }),
    });
};
