...
const createApplicationAction = async ({ sdk, args }) => {
    ...
    const name = isNonInteractive ? args.name : await (0, enterApplicationNameOrPrompt_1.enterApplicationNameOrPrompt)({ name: args.name });
    const whitelistDomains = isNonInteractive
        ? (0, exports.whitelistArgParser)(args.whitelistDomains)
        : await (0, getWhitelistDomainsOrPrompt_1.getWhitelistDomainsOrPrompt)({
