...
const initConfiguration = async ({ sdk }) => {
    ...
    const distDir = await (0, enterDirectoryPathPrompt_1.enterDirectoryPathPrompt)({ message: (0, translation_1.t)('specifyDistDirToSiteUpl') });
    const buildCommand = await (0, selectBuildCommandOrSkip_1.selectBuildCommandOrSkip)();
    const config = { sites: [{ slug: site.slug, distDir, buildCommand }] };
