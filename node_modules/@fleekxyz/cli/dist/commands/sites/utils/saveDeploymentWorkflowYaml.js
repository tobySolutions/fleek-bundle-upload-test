...
const saveDeploymentWorkflowYaml = async ({ yamlContent, yamlPath, personalAccessToken, projectId, output, }) => {
    try {
        await fs_1.promises.writeFile(yamlPath, yamlContent);
        output.printNewLine();
        output.success((0, translation_1.t)('githubActionWrkflSavedTo', { path: chalk_1.default.underline(chalk_1.default.cyan(yamlPath)) }));
        output.printNewLine();
