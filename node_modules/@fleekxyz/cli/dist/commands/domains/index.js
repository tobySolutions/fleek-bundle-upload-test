...
exports.default = (program) => {
    const cmd = program.command('domains').option('-h, --help', (0, translation_1.t)('printHelp')).description((0, translation_1.t)('domainsDesc'));
    cmd
        .command('list')
    ...
    cmd
        .command('delete')
        .option('--id <string>', (0, translation_1.t)('commonNameOfSubjectToAction', { name: (0, translation_1.t)('id'), subject: (0, translation_1.t)('domain'), action: (0, translation_1.t)('delete') }))
        .option('--hostname <string>', (0, translation_1.t)('commonNameOfSubjectToAction', { name: (0, translation_1.t)('hostname'), subject: (0, translation_1.t)('ens'), action: (0, translation_1.t)('delete') }))
