...
const createDomainAction = async ({ sdk, args }) => {
    ...
    const zone = await (0, getZoneForSiteOrPrivateGateway_1.getZoneForSiteOrPrivateGateway)(site ? { site, sdk } : { privateGateway, sdk });
    if (zone === null) {
    ...
    cli_1.output.printNewLine();
    cli_1.output.success((0, translation_1.t)('commonItemActionSuccess', { subject: `${(0, translation_1.t)('domain')} ${cli_1.output.quoted(hostname)}`, action: (0, translation_1.t)('created') }));
    cli_1.output.printNewLine();
