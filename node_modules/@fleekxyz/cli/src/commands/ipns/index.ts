...
export default (program: Command) => {
  const cmd = program.command('ipns').option('-h, --help', 'Print help').description(t('ipnsDescription'));

  cmd
    .command('create')
    .description(t('ipnsCreateDescription'))
    .option('--siteSlug <string>', t('commonIdentifierXAssignedToSubjectY', { name: 'humanReadableSlugDesc', subject: t('ipnsRecord') }))
    .option('--siteId <string>', t('commonIdentifierXAssignedToSubjectY', { name: t('uniqueIdentifier'), subject: t('ipnsRecord') }))
    .action((options: { siteId?: string; siteSlug?: string }) => createActionHandler(options));
  ...
  cmd
    ...
    .action((options: { name: string; hash: string }) => publishActionHandler(options));
  ...
  cmd
    ...
    .option('--name <string>', t('commonNameOfSubjectToAction', { name: t('name'), subject: t('ipnsRecord'), action: t('delete') }))
